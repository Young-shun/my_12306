 ...
 */
@Component
public class StudentTicketDiscountStrategy implements AbstractExecuteStrategy<TicketDiscountCalculateDTO, Integer> {

  @Override
  public String mark() {
    return TicketDiscountStrategyMark.buildMark(2);
  }

  @Override
  public Integer executeResp(TicketDiscountCalculateDTO requestParam) {
    if (Objects.equals(requestParam.getSeatType(), VehicleSeatTypeEnum.SECOND_CLASS.getCode())) {
      return BigDecimal.valueOf(requestParam.getOriginAmount())
          .multiply(new BigDecimal("0.75"))
          .setScale(0, RoundingMode.HALF_UP)
          .intValue();
    }
    return requestParam.getOriginAmount();
  }
}
