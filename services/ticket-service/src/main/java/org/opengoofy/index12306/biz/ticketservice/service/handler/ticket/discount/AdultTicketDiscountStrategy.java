 ...
 */
@Component
public class AdultTicketDiscountStrategy implements AbstractExecuteStrategy<TicketDiscountCalculateDTO, Integer> {

  @Override
  public String mark() {
    return TicketDiscountStrategyMark.buildMark(0);
  }
