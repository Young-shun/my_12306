 ...
 */
@Component
public class ChildTicketDiscountStrategy implements AbstractExecuteStrategy<TicketDiscountCalculateDTO, Integer> {

  @Override
  public String mark() {
    return TicketDiscountStrategyMark.buildMark(1);
  }
